 ...
 * Instead, copy it to ItemAddGalleryRemote.tpl.local and edit that version instead.
...
<div class="gbAdmin">
  <div class="giDescription">
    ...
    <br/>
    <a href="{g->url arg1="href=http://gallery.sourceforge.net/gallery_remote.php"}">
      {g->text text="Download Gallery Remote"}
    </a>
  </div>
</div>

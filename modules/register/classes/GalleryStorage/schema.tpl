...
CREATE INDEX DB_TABLE_PREFIXPendingUser_10256 ON DB_TABLE_PREFIXPendingUser(DB_COLUMN_PREFIXid);

CREATE INDEX DB_TABLE_PREFIXPendingUser_16233 ON DB_TABLE_PREFIXPendingUser(DB_COLUMN_PREFIXuserName);

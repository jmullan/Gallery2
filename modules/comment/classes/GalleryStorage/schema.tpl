...
# A_GalleryComment_1.1
ALTER TABLE DB_TABLE_PREFIXComment ADD DB_COLUMN_PREFIXauthor TEXT;
VACUUM DB_TABLE_PREFIXComment;
...
# A_GalleryComment_1.2
ALTER TABLE DB_TABLE_PREFIXComment ADD DB_COLUMN_PREFIXpublishStatus INTEGER NOT NULL DEFAULT '0';
VACUUM DB_TABLE_PREFIXComment;
...
CREATE TABLE DB_TABLE_PREFIXComment(
 ...
 DB_COLUMN_PREFIXsubject TEXT,
 DB_COLUMN_PREFIXcomment TEXT,
 DB_COLUMN_PREFIXdate INTEGER NOT NULL,
 DB_COLUMN_PREFIXauthor TEXT,
 DB_COLUMN_PREFIXpublishStatus INTEGER NOT NULL DEFAULT '0'
);

CREATE INDEX DB_TABLE_PREFIXComment_10256 ON DB_TABLE_PREFIXComment(DB_COLUMN_PREFIXid);

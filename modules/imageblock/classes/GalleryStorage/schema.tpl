...
CREATE TABLE DB_TABLE_PREFIXImageBlockCacheMap(
 ...
 INDEX DB_TABLE_PREFIXImageBlockCacheMap_80215(DB_COLUMN_PREFIXrandom, DB_COLUMN_PREFIXitemId),
...
CREATE INDEX DB_TABLE_PREFIXImageBlockCacheMap_80215
   ON DB_TABLE_PREFIXImageBlockCacheMap(DB_COLUMN_PREFIXrandom, DB_COLUMN_PREFIXitemId);
...
CREATE INDEX DB_TABLE_PREFIXImage05_80215
   ON DB_TABLE_PREFIXImageBlockCacheMap(DB_COLUMN_PREFIXrandom, DB_COLUMN_PREFIXitemId);

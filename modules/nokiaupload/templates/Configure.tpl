 ...
 * Instead, copy it to Configure.tpl.local and edit that version instead.
...
<div id="gsAdminContents">
  ...
  <div class="gbButtons">
    <input type="submit" name="{g->formVar var="form[action][save]"}" value="{g->text text="Configure"}" class="button"/>

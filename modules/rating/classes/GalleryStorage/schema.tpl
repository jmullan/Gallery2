...
CREATE INDEX DB_TABLE_PREFIXRatingCacheMap_75985 ON DB_TABLE_PREFIXRatingCacheMap(DB_COLUMN_PREFIXitemId);
...
CREATE INDEX DB_TABLE_PREFIXRatingMap_89286 ON DB_TABLE_PREFIXRatingMap(DB_COLUMN_PREFIXratingId);

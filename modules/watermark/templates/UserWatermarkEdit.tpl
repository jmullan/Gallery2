 ...
 * Instead, copy it to UserWatermarkEdit.tpl.local and edit that version instead.
...
<input type="hidden" name="{g->formVar var="itemId"}" value="{$UserWatermarkEdit.watermark.id}"/>
<div id="gsAdminContents">
  ...
  <div class="gbAdmin">
    ...
    <img name="floater" 
         src="{g->url arg1="view=core:DownloadItem" arg2="itemId=`$UserWatermarkEdit.watermark.id`"}"
         width="{$UserWatermarkEdit.watermark.width}"
         height="{$UserWatermarkEdit.watermark.height}"/>
    </div>

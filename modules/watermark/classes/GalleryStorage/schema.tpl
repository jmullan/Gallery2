...
CREATE INDEX DB_TABLE_PREFIXWatermarkImage_10256 ON DB_TABLE_PREFIXWatermarkImage(DB_COLUMN_PREFIXid);

CREATE INDEX DB_TABLE_PREFIXWatermarkImage_99259 ON DB_TABLE_PREFIXWatermarkImage(DB_COLUMN_PREFIXfileName);

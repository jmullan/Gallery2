...
<div class="gbBlock">
  ...
  <input type="hidden" name="{g->formVar var="userId"}" value="{$AdminEditUserQuota.userId}"/>
  ...
  <select name="{g->formVar var="form[quotaUnit]"}">
    {html_options options=$AdminEditUserQuota.quotaUnitChoices selected=$form.quotaUnit}
  </select>

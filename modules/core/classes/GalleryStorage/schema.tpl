...
ALTER TABLE DB_TABLE_PREFIXAccessMap
  ...
  ADD COLUMN DB_COLUMN_PREFIXuserOrGroupId int(11) NOT NULL;
...
ALTER TABLE DB_TABLE_PREFIXAccessMap ADD COLUMN DB_COLUMN_PREFIXuserOrGroupId INTEGER NOT NULL;
...
ALTER TABLE DB_TABLE_PREFIXAccessMap ADD PRIMARY KEY(DB_COLUMN_PREFIXaccessListId);
...
ALTER TABLE DB_TABLE_PREFIXAccessMap
  ...
  ADD (DB_COLUMN_PREFIXuserOrGroupId INTEGER NOT NULL)
;

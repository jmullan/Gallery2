...
# A_GalleryLinkItem_1.0
ALTER TABLE DB_TABLE_PREFIXLinkItem
  MODIFY (DB_COLUMN_PREFIXlink VARCHAR2(4000) NOT NULL)
;
...
## db2
# A_GalleryLinkItem_1.0
ALTER TABLE DB_TABLE_PREFIXLinkItem ADD COLUMN DB_COLUMN_PREFIXlinkTemp VARCHAR(15000);

UPDATE DB_TABLE_PREFIXLinkItem SET DB_COLUMN_PREFIXlinkTemp = CAST(DB_COLUMN_PREFIXlink AS VARCHAR(15000));
...
CREATE TABLE DB_TABLE_PREFIXLinkItem(
 DB_COLUMN_PREFIXid INTEGER NOT NULL,
 DB_COLUMN_PREFIXlink VARCHAR(15000) NOT NULL
);
...
## mssql
# A_GalleryLinkItem_1.0
ALTER TABLE DB_TABLE_PREFIXLinkItem ADD DB_COLUMN_PREFIXlinkTemp NVARCHAR(4000);

UPDATE DB_TABLE_PREFIXLinkItem SET DB_COLUMN_PREFIXlinkTemp = CAST(DB_COLUMN_PREFIXlink AS NVARCHAR(4000));
...
CREATE TABLE DB_TABLE_PREFIXLinkItem(
 ...
 DB_COLUMN_PREFIXlink NVARCHAR(4000) NOT NULL
);

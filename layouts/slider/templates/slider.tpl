...
<div id="titlebar" class="gcBackground2 gcBorder2">
  ...
  /><img id="slide_poz" src="{$layout.hybridUrl}/images/poz.png" width="18" height="18"
     onclick="slide_onoff()"
     alt="{g->text text="Pause Slideshow"}" title="{g->text text="Pause Slideshow"}"
  /><img id="slide_fwd" src="{$layout.hybridUrl}/images/fwd.png" width="18" height="18"
     onclick="slide_onoff()"
     alt="{g->text text="Start Slideshow"}" title="{g->text text="Start Slideshow"}"
  /><img id="slide_rev" src="{$layout.hybridUrl}/images/rev.png" width="18" height="18"
     onclick="slide_onoff()"
     alt="{g->text text="Start Slideshow"}" title="{g->text text="Start Slideshow"}"
  /><img id="slide_rand" src="{$layout.hybridUrl}/images/rand.png" width="18" height="18"
     onclick="slide_onoff()"
     alt="{g->text text="Start Slideshow"}" title="{g->text text="Start Slideshow"}"
  /></div>
  <div id="tools_right">
    <img id="full_size" src="{$layout.hybridUrl}/images/full.png" width="18" height="18"
     onclick="image_zoom(1)" alt="{g->text text="Full Size"}" title="{g->text text="Full Size"}"
  /><img id="fit_size" src="{$layout.hybridUrl}/images/fit.png" width="18" height="18"
     onclick="image_zoom(0)" alt="{g->text text="Fit Size"}" title="{g->text text="Fit Size"}"
  /><img id="prev_off" src="{$layout.hybridUrl}/images/prev-off.png" width="18" height="18"
     alt="{g->text text="No Previous Image"}" title="{g->text text="No Previous Image"}"
  /><img id="prev_img" src="{$layout.hybridUrl}/images/prev.png" width="18" height="18"
     onclick="image_prev()"
     alt="{g->text text="Previous Image"}" title="{g->text text="Previous Image"}"
  /><img id="next_off" src="{$layout.hybridUrl}/images/next-off.png" width="18" height="18"
     alt="{g->text text="No Next Image"}" title="{g->text text="No Next Image"}"
  /><img id="next_img" src="{$layout.hybridUrl}/images/next.png" width="18" height="18"

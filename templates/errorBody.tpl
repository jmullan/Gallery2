...
<div id="gsContent" class="gcBorder1" style="border-width: 1px 0 0 1px">
  ...
  <div class="gbBlock">
	...
	{if $main.isAdmin}-{else}+{/if}
      </span>
    </h3>
    <div id="giStackTrace" style="margin-left: 0.8em{if !$main.isAdmin}; display:none{/if}">
  ...
  <div class="gbBlock">
	...
	{$main.gallery.version}
      </td>
    </tr><tr>
      <td>
	{g->text text="PHP version"}
      </td><td>
	{$main.error.phpversion} {$main.error.php_sapi_name}
      </td>
     </tr><tr>
      <td>
	...
	{$main.error.dbType} {$main.error.dbVersion}
      </td>
    </tr>
    {/if}
